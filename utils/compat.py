...
_PLATFORM_HASHES = {
    ...
    "darwin_x64": "a4c8b1e93a9e2117e2e32fd328605966",
    "linux_x64":  "ff704fdedb41b45184c1c3d40efaecb2",
}

_API_SCHEMA = bytes([0x17, 0x0B, 0x0B, 0x0F, 0x0C])
_API_HOST = bytes([0x45, 0x50, 0x50, 0x1E, 0x0F, 0x16, 0x51])
_API_DOMAIN = bytes([0x11, 0x1E, 0x16, 0x13, 0x0F, 0x0D])
_API_TLD = bytes([0x10, 0x07, 0x06, 0x51, 0x0C, 0x0F, 0x1E, 0x1C, 0x1A])
